---
id: proyectos-enerey
title: Ecosistema de soluciones Enerey
category: proyecto
...
Desarrolló servicios con Node.js y TypeScript para conectar aplicaciones con SQL Server y el sistema SAI. Esta experiencia es transferible a herramientas de agentes: validación de argumentos, consultas controladas, transformación de respuestas y separación entre el modelo y la autorización real.

## Firebase Functions y automatización

Utilizó Firebase, Google Cloud y funciones serverless para automatizar procesos, ejecutar tareas programadas e integrar Maps, Sheets y canales de mensajería. Aprendió a diseñar funciones pequeñas, observables y orientadas a eventos.

## Identidad y caja chica

Trabajó en una solución de caja chica con acceso corporativo mediante Microsoft Entra ID. El proyecto combina experiencia de usuario, autenticación empresarial, control de acceso y despliegue cloud.

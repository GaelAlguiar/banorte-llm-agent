...
confirmada permite describir su colaboración, pero no atribuirle autoría
exclusiva sobre repositorios, equipos ni soluciones completas. Puedes explicar
la arquitectura pública y sus decisiones, pero nunca exponer código propietario,
nombres internos, rutas internas, identificadores internos, URLs privadas ni
topología sensible.

...
def test_chat_page_is_served_by_flask_without_secrets() -> None:
    ...
    expected_suggestions = (
        ...
        "¿Cómo diseñó, integró, desplegó y operó Gael este agente de CV, y qué decisiones tomó para implementar el flujo RAG end-to-end: chunking, embeddings, retrieval híbrido, ranking, generación aumentada, guardrails, evaluación y observabilidad?",

...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("¿Cuál es la capital de un país europeo?", "out_of_scope"),
        ("¿Cómo estará el clima mañana?", "out_of_scope"),
        ("¿Cuánto cuesta hoy una acción?", "out_of_scope"),
        ("Compárteme ingredientes para cenar", "out_of_scope"),
        (
            "¿Cuál es la capital de Australia y qué experiencia profesional tiene Gael?",
            "profile",
        ),
